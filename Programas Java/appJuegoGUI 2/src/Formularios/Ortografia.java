...
public class Ortografia extends javax.swing.JFrame {
    ...
    String ejerciciosO [] = {"Escribe correctamente: ERBIR",
    "Escribe correctamente: ALCOL",
    "Escribe la palabra errónea: YO CONPRE POLLO ASADO",
    "Escribe correctamente: TU ERMANO MALLOR",
    "Escribe la palabra errónea: CÓRRELE, HAY VIENEN"};
    
    String respuestasO [] = {"HERVIR",
    "ALCOHOL",
    "CONPRE",
    "TU HERMANO MAYOR",
    "HAY"};
    
    String respMinsO [] = {"hervir",
    "alcohol",
    "conpre",
    "tu hermano mayor",
    "hay"};
    ...
    private void initComponents() {
        ...
        jLabel3.setText("APRENDER ORTOGRAFÍA");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(jTextRespuesta, javax.swing.GroupLayout.PREFERRED_SIZE, 387, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
    ...
    private void jButtonComprobarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonComprobarActionPerformed
        ...
        if(Metodos.verificarMayusRespuesta(this.jTextRespuesta.getText())){
            if(respuestasO[contador].equals(this.jTextRespuesta.getText())){
            ...
            if(respMinsO[contador].equals(this.jTextRespuesta.getText())){
        ...
        if(contador < ejerciciosO.length){
                this.jTextRespuesta.setText("");
                this.jLabelNumEjercicio.setText(Metodos.numEjercicio(contador+1,ejerciciosO.length));
                this.jLabelEjercicio.setText(ejerciciosO[contador]);
                this.jLabelPuntuacion.setText(Integer.toString(puntuacion));
            }
        else{
            JOptionPane.showMessageDialog(null, "¡FELICIDADES, HAS COMPLETADO EL NIVEL DE ORTOGRAFÍA!\nPresiona ACEPTAR para volver al Menú");
