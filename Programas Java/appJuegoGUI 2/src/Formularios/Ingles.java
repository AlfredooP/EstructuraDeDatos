...
public class Ingles extends javax.swing.JFrame {
    ...
    private void jButtonComprobarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonComprobarActionPerformed
        ...
        if(Metodos.verificarMayusRespuesta(this.jTextRespuesta.getText())){
            ...
            if(respMinsI[contador].equals(this.jTextRespuesta.getText())){
        ...
        if(contador < ejerciciosI.length){
                ...
                this.jLabelNumEjercicio.setText(Metodos.numEjercicio(contador+1,ejerciciosI.length));
                this.jLabelEjercicio.setText(ejerciciosI[contador]);
