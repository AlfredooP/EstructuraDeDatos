...
public class MayusYMinus extends javax.swing.JFrame {
    ...
    private void jButtonComprobarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonComprobarActionPerformed
        ...
        if(contador < ejerciciosMM.length){
                ...
                this.jLabelNumEjercicio.setText(Metodos.numEjercicio(contador+1,ejerciciosMM.length));
                this.jLabelEjercicio.setText(ejerciciosMM[contador]);
                this.jLabelPuntuacion.setText(Integer.toString(puntuacion));
        }
        else{
            JOptionPane.showMessageDialog(null, "¡FELICIDADES, HAS COMPLETADO EL NIVEL DE MAYUSCULAS Y MINUSCULAS!\nPresiona ACEPTAR para volver al Menú");
